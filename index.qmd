...
hotspots <- denmex::hotspots_hex[loc, ]
...
# Step 2. extract the locality ####
hotspots_h3 <- hotspots[loc, ]

# Step 3- Interactive Map ####
pal <- rcartocolor::carto_pal(n = max(hotspots_h3$intensity_gi), 
                              name = "OrYel")
mapview::mapview(hotspots_h3,
                 zcol = "intensity_gi",
                 layer.name = "Intensidad",
                 label = FALSE,
                 color = "white",
...
risk <- denhotspots::risk_ageb(betas = denmex::eggs_betas_11_guanajuato,
